...
  sender.Add("name", "rpa_2205_processos@sicredi.com.b")
  'sender.Add("nameCompany", "SUREG")
  'sender.Add("companyIdentificationCode", "2205")
  sender.Add("email", "rpa_2205_processos@sicredi.com.br")
...
  End If
  'observersId.Add("name", "rpa_2205_processos")
...
  recipients.Add("emails", "rpa_2205_processos@sicredi.com.br")
